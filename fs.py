...
def skb_bestk(x,y,k,model,score_f,feat_names,short_score,classification,estimator):
    ...
    train.trainmod(x_skb,y,feat_names,short_score,classification,estimator)
            

def skb(x,y,feat_names,short_score,classification,estimator):
...
def rfecv(x,y,feat_names,short_score,classification,estimator):
    ...
    train.trainmod(x_rfecv,y,feat_names,short_score,classification,estimator)
